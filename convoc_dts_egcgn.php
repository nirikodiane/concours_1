...
require('connect.php');
$requette=$bdd->query('SELECT * FROM candidats WHERE niveau="DTS" AND ecole="EGCGN" ORDER BY id_candidat');
?>
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Convocation <a href="imprime_tout_convocation.php"> &nbsp &nbsp &nbsp Imprimer tout</a></h3>
...
$convoc_dts_egcgn="nav-link active";
?>
