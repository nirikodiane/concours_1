    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text"   name="N° CIN du candidat" class="form-control" id="exampleInputEmail1" placeholder="Numéro CIN du candidat" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
...
<?php } ?>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select class="form-control" name="parcours2">
                    <div class="form-group">
                    <option></option>         
                    <option value="TAM-I">TAM - Option Industriel</option>
                    <option value="NTE">NTE</option>
                    <option value="ICE">ICE</option>
                    <option value="TAM-N">TAM - Option Navale</option>
                </select>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <input type="hidden" name="ecole" value="EGI">
...
$menu = "Nouveau candidat INGENIORAT / EGI-EGN";
