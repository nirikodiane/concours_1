...
require 'connect.php';
$salle=$_GET['id'];
$recup=$bdd->prepare('SELECT * FROM candidats WHERE salle=? AND niveau!="DTS" AND centre="Antsiranana" ORDER BY niveau, parcours1, nom');
...
<b><p>
  Concours d'entrée en 2nd cycle DTSS / Ingéniorat <?php echo $date_concours["annee_univ"];?>
