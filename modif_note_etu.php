...
?>
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Modification de note</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="action_modif_note_etu.php" method="POST">
...
$requette3->execute(array($change));
$notes=$requette3->fetch();
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <input type="number" class="form-control" name="<?php echo "matiere".$i;?>" value="<?php $j="matiere".$i; echo $notes[$j]; ?>" step="0.01" min="0" max="20" required>
