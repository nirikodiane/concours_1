...
$recup=$bdd->query('SELECT * FROM etiquette WHERE niveau!="DTS" GROUP BY niveau ORDER BY niveau');
...
<hr class="new1">
<i>
<h1 style="margin-left:400px; font-size:14pt;">CONCOURS D’ENTREE EN CYCLE <?php echo $message['niveau']; ?> <br/>
Session du <?php echo $date_concours["session"];?> <br/>
Niveau : <?php echo $message['niveau']; ?></h1>
</i>
...
<tr><td style="width:120px; height:40px; text-decoration: underline; text-decoration-color: black;">EPREUVE :</td><td><?php echo "ORALE"; ?></td></tr>
