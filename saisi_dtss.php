...
<form class="" method="POST" action="enregistre_candidat.php">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label for="N° CIN">N° CIN:</label>
                <input type="number"   name="N° CIN du candidat" class="form-control" id="exampleInputEmail1" placeholder="Numéro CIN du candidat" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label for="Lieu CIN">Lieu CIN :</label>
                <input type="text"   name="Lieu CIN" class="form-control" id="exampleInputEmail1" placeholder="lieu de CIN du candidat" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
...
<?php
    ...
    $reponse1->execute(array($_GET['ecole'], 'DTSS'));
...
<?php
    ...
    $reponse2->execute(array($_GET['ecole'], 'DTSS'));
...
<?php } ?>
    ...
    <div class="row">
        ...
        <input type="hidden" name="niveau" value="DTSS">
...
if ($_GET['ecole']=='EGI')
{
$menu = "Nouveau candidat DTSS / EGI";
$menu_dtss_egi="nav-link active";
$menu_dtss_egcgn="nav-link";
$menu_dtss_egmcs="nav-link";
$menu_saisi_dtss="nav-item menu-open";
}

if ($_GET['ecole']=='EGCGN')
{
$menu = "Nouveau candidat DTSS / EGCGN";
$menu_dtss_egi="nav-link";
$menu_dtss_egcgn="nav-link active";
$menu_dtss_egmcs="nav-link";
$menu_saisi_dtss="nav-item menu-open";
}
...
if ($_GET['ecole']=='EGMCS')
{
$menu = "Nouveau candidat DTSS / EGMCS";
$menu_dtss_egi="nav-link";
$menu_dtss_egcgn="nav-link";
$menu_dtss_egmcs="nav-link active";
$menu_saisi_dtss="nav-item menu-open";
}
?>
