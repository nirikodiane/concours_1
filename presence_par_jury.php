...
Fiche de présence d'épreuve orale au concours d'entrée en DTSS / Ingéniorat 2024-2025
<br>Session du <?php echo $date_concours["Premier_Date"];?> et <?php echo $date_concours["Deuxiem_Date"];?> 2024
<br>
<?php
//if (isset($message1['salle_jury'])) {echo "Salle : ".$message1['salle_jury']."<br>";}
if (isset($jury)) {echo $jury;}
?>
</p>
  ...
  ?>
    <tr style="width: auto; height: 30px;">
      ...
      <td style="text-align:left;"><?php echo sprintf("%'03d", $message['numero'])."24".$message['parcours1'];?></td>
       ...
       <td style="text-align:auto;width: auto;">  </td>
  </tr>
  <?php
  $i++;
  $sexe=$message['sexe'];
