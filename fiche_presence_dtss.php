...
<html>
  <head>
    <meta charset="utf-8"/>
    <title>Fiche_de_presence_DTSS_<?php if (isset($salle)) {echo $salle;} if (isset($centre)) {echo $centre;}  echo "_".$_GET['ecole'];?></title>
  </head>
  <body>
    <style>
    *{
...
<b><p>
  ...
  Fiche de présence au concours d'entrée en en formation de DTSS et Ingéniorat <?php echo $date_concours["annee_univ"];?>
...
<p style="text-align: center;">Date:___________________ Epreuve:____________________________ Heure:_______________</p>
</b>
